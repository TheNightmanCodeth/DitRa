                            ...
                            children:
                              ...
                              if (thisComment is MoreComments) {
                                ...
                                if(thisComment.replies != null) {
                                  replies = Column(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: List.generate(thisComment.replies.length, (index) {
                                      if (thisComment.replies[index] is MoreComments) {
                                        return Card(
                                          child: Container(
                                        ...
                                        return Card(
                                          child: Container(
                                            margin: EdgeInsets.only(left: 18.0),
                                            child: MarkdownBody(data: thisComment.replies.comments[index].body),
                                ...
                                } else replies = Container(height: 0.0, width: 0.0,);
                                return Column(
                                  children: [
                                    Card(
                                      child: Container(
